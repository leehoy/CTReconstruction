...
class Reconstruction(object):
    ...
    def distance(self, DetectorIndex, DetectorBoundary, Source, Detector, angle, Xplane, Yplane, Zplane):
        ...
        if (abs(dy / dx) * abs(Source[0] - Detector[0]) >= abs(Source[1] - Detector[1]) and
                abs(dz / dx) * abs(Source[0] - Detector[0]) >= abs(Source[2] - Detector[2])):
        ...
        elif (abs(dx / dy) * abs(Source[1] - Detector[1]) >= abs(Source[0] - Detector[0]) and
              abs(dz / dy) * abs(Source[1] - Detector[1]) >= abs(Source[2] - Detector[2])):
            start_time = time.time()
        ...
        elif (abs(dx / dz) * abs(Source[2] - Detector[2]) >= abs(Source[0] - Detector[0]) and
              abs(dy / dz) * abs(Source[2] - Detector[2]) >= abs(Source[1] - Detector[1])):
