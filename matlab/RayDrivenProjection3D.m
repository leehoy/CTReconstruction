...
for angle_index=1:nTheta
    ...
    DetectorZ=0;
    DetectorLengthH=(-NumberOfDetectorPixels(1)/2:NumberOfDetectorPixels(1)/2)*DetectorPixelSizeH; %horizontal detector length
    DetectorLengthV=(-NumberOfDetectorPixels(2)/2:NumberOfDetectorPixels(2)/2)*DetectorPixelSizeV; %horizontal detector length
